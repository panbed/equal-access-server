...
export declare class AriaUtil {
     ...
     * @memberOf AriaUtil
     */
    static isNavigationOwnedOrControlled(element: Element): boolean;
    /**
     ...
     * @returns
     */
    static getLandmarkAccNames(doc: any): any;
    /**
     ...
     * @returns
     */
    static isLandmarkNameUnique(element: any, role: any, considerNoneLabel?: boolean): boolean;
